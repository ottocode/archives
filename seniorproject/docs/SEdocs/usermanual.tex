...
\newcommand{\NOCCPVersion}{0.0.1}
\newcommand{\NOCCFVersion}{0.0.1}
\newcommand{\NOCCBVersion}{0.0.1}
\newcommand{\NOCCAVersion}{0.0.1}

\begin{document}
\begin{center}
\Huge
User Manual\\\vspace{2cm}
...
\section{Name}
NOCC, the "Non-Optimized C Compiler" or, alternatively, "Nick Otto's C Compiler."
Version \NOCCVersion.
...
\section{Description}
NOCC is a C compiler that specifically targets the ARMv6 architecture.  
Up through version 1, that will be the only supported target.
Other C compilers are more likely to give far better results.
