...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:TextBox ID="tbxEmailSignIn" runat="server"></asp:TextBox>
         ...
         <tr>
            ...
            <td>
                <asp:TextBox ID="tbxPasswordSignIn" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:TextBox ID="tbxFirstNameRegister" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="tbxLastNameRegister" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="tbxEmailRegister" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator
         ...
         <tr>
            ...
            <td>
                <asp:TextBox ID="tbxPasswordRegister" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator
         ...
         <tr>
            ...
            <td>
                <asp:TextBox ID="tbxConfirmPasswordRegister" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator
