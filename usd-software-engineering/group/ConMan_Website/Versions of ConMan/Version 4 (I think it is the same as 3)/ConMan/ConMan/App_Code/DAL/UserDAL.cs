    ...
    public class UserDAL
    {
        ...
        public static User GetUserByID(Int64 id)
        {
            ...
            using (SqlConnection sqlConn = new SqlConnection(connectionString))
            {
                ...
                String selectCommand = "SELECT * FROM UserInfo WHERE id = @id";
                ...
                {
                    user = new User();
                    user.ID = Convert.ToInt64(ds.Tables[0].Rows[0]["id"]);
                    user.FirstName = Convert.ToString(ds.Tables[0].Rows[0]["first_name"]);
                    user.LastName = Convert.ToString(ds.Tables[0].Rows[0]["last_name"]);
