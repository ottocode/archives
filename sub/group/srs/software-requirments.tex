...
\conman is inspired by existing attempts made to create a useful calendar, checklist, and task management software suite such as Trello, SourceForge, and some basic calendar applications for iPhone and Android.  \conman is a re-making of the task-management suite that emphasizes simplicity and ease of use as the primary development and design philosophies.
...
\conman deploys on an ASP.NET server using a SQL Server Express database.
