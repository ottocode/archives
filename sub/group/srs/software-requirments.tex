...
\texttt{ConMan's} functions can be divided into two categories, application functions and user functions.  Application functions are the functions that describe the basic workings of \texttt{ConMan}.  
They include:
\begin{enumerate}
...
Manager functions are only available to users designated as project managers when their team account was created.
\begin{enumerate}
