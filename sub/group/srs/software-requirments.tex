...
The system will have 2 main components that interact with the user. The 1st component is a desktop application that will enable the user to create their own presentation and display it. The 2nd component is an Android application that will allow the presenter of the presentation (created via the 1st Component) to control the presentation. The presenter can scroll/flip through presentation slides, zoom in/out of the presentation, highlight text on the presentation, draw figures on the slides, and point to specific content (like a laser pointer) through a simple Android UI and gestures. 
